...
function TodoItem({todo,filtered,complete,editId,editText,setEdittext,handleSave, handleText}){
    ...
    return(
        ...
        {editId === todo.id?(
            ...
            <p className={style.taskText} style={{textDecoration:todo.done?"line-through":"none",color:color,opacity:todo.done?0.4:1}}>{todo.text}</p>
        )}
